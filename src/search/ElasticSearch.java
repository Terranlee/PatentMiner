...
public class ElasticSearch {
	...
	public static void main(String[] args){
		...
		SearchResponse response = client.prepareSearch("newenergy").setTypes("split").setSearchType(SearchType.DFS_QUERY_AND_FETCH).setQuery(QueryBuilders.queryString("保温 加热")).setSize(20).execute().actionGet();
		...
		System.out.println("Search time: " + (time_three - time_two));
